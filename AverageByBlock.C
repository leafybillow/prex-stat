...
void AverageByBlock(Int_t block_id){
  ...
  vector<TString> fDetectorNameList={"asym_bcm_an_us","asym_bcm_an_ds",
				     ...
				     "dit_asym_us_avg","dit_asym_usr","dit_asym_usl",
				     "dit_asym_us_dd_div2","dit_asym_ds_avg",
				     "dit_asym_left_dd","dit_asym_right_dd"};
  ...
  for(int islug=1;islug<=94;islug++){
    ...
    TTree* burst_tree = (TTree*)input_file->Get("norm");
    if(burst_tree==NULL){
